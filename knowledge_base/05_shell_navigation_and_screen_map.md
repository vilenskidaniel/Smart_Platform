...
Shell при этом не должен:

- хранить бизнес-логику `Irrigation`, `Turret` или других product modules;
- напрямую дергать GPIO или притворяться owner-side runtime executor;
- сам придумывать аппаратные safety-правила вместо owner/runtime layer;
- превращаться в витрину внутренних runtime- и diagnostics-слоев как будто это самостоятельный пользовательский продукт.
