# Briefs И Точки Входа

Эта папка нужна для запуска отдельных модульных чатов без необходимости перечитывать весь проект с нуля.
...
Эти файлы полезны как техническая поддержка, но не должны подменять собой product-level roadmap:

- [strobe_module.md](/c:/Users/vilen/OneDrive/Dokumentumok/PlatformIO/Projects/Smart_Platform/briefs/strobe_module.md)
- [system_core.md](/c:/Users/vilen/OneDrive/Dokumentumok/PlatformIO/Projects/Smart_Platform/briefs/system_core.md)
- [sync_and_storage.md](/c:/Users/vilen/OneDrive/Dokumentumok/PlatformIO/Projects/Smart_Platform/briefs/sync_and_storage.md)
