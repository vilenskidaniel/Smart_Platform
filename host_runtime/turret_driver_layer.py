...
class TurretDriverLayer:
    ...
    def _seed_bindings(self) -> dict[str, dict[str, Any]]:
        ...
        return {
            ...
            "attack_audio": self._binding("attack_audio", "Attack Audio", "stub", "unbound", False, "awaiting dual-channel attack-audio driver details"),
            "voice_fx": self._binding("voice_fx", "Voice FX", "stub", "virtual", False, "awaiting bluetooth speaker and microphone integration details"),
