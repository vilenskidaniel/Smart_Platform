...
- `laboratory_prompt.md` — один из ключевых deep-module prompts, задающий структуру, глубину и метод работы для сложного инженерного блока;
...
- при проработке крупных модульных развилок лучше регулярно использовать структурированные опросники с вариантами ответа, кратким пояснением каждого варианта, отмеченным рекомендуемым выбором и отдельным полем для расширенного ответа или заметок пользователя;
