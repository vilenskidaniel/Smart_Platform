# System Shell Navigation Alignment

Этот документ фиксирует один компактный переходный слой для `System Shell / navigation contract`.
...
4. [27_system_shell_v1_spec.md](27_system_shell_v1_spec.md)
...
- `Service/Test` допустим как внутренний stage-term и route-alias, но не как основной label.
